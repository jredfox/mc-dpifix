...
public class DpiFixTransformer implements IDpiFixTransformer {
	...
	public void patchFullScreen(String notch_mc, ClassNode classNode) 
	{
		...
		String notch_leftClickCounter = (ForgeVersionProxy.minorVersion == 11 ? "W" : ForgeVersionProxy.minorVersion == 10 ? "W" : "V");
		String notch_fullscreen = (ForgeVersionProxy.minorVersion == 11 ? "P" : ForgeVersionProxy.minorVersion == 10 ? "P" : "O");
		...
		{	
			...
			AbstractInsnNode spot = CoreUtils.getLastMethodInsn(runGame, Opcodes.INVOKEVIRTUAL, onesixnotch ? (ForgeVersionProxy.minorVersion == 11 ? "lv" : ForgeVersionProxy.minorVersion == 10 ? "lu" : "ls") : "net/minecraft/profiler/Profiler", CoreUtils.getObfString("endSection", onesixnotch ? "b" : "func_76319_b"), "()V", false);
	...
	public void patchMaxResFix(String notch_mc, ClassNode classNode) 
	{
		...
		resize.instructions.insert(CoreUtils.getFieldInsnNode(resize, Opcodes.PUTFIELD, mcClass, CoreUtils.getObfString("displayHeight", onesixnotch ? (ForgeVersionProxy.minorVersion == 11 ? "e" : ForgeVersionProxy.minorVersion == 10 ? "e" : "d") : "field_71440_d"), "I"), viewport);
	...
	public void patchGuiMainMenu(ClassNode classNode)
	{
		...
		MethodInsnNode targ = CoreUtils.getMethodInsnNode(m, Opcodes.INVOKEVIRTUAL, !onesixnotch ? "net/minecraft/client/renderer/texture/TextureManager" : (ForgeVersionProxy.minorVersion == 11 ? "bim" : ForgeVersionProxy.minorVersion == 10 ? "bij" : "bib"), CoreUtils.getObfString("bindTexture", !onesixnotch ? "func_110577_a" : "a"), !onesixnotch ? "(Lnet/minecraft/util/ResourceLocation;)V" : (ForgeVersionProxy.minorVersion == 11 ? (ForgeVersionProxy.buildVersion > 878 ? "(Lbjo;)V" : "(Lbjp;)V") : ForgeVersionProxy.minorVersion == 10 ? "(Lbjl;)V" : "(Lbjd;)V"), false);
		InsnList li = new InsnList();
